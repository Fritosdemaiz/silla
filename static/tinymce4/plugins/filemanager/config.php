...
$base_url="http://www.canina.quijost.com/a00"; //url base of site if you want only relative url leave empty
$upload_dir = '/static/media/uploads/'; // path from base_url to upload base dir
$current_path = '../../../../static/media/uploads/'; // relative path from filemanager folder to upload files folder
